export default function Sidebar(props) {
    ...
    return (
        <div className="Sidebar">
            ...
            <nav>
                <ul>
                    <li><button className="notes" onClick={() => props.updateView('all-notes')}>All Notes</button></li>
                    <li><button className="collections">Collections</button></li>
                    <li><button className="tags">Tags</button></li>
                    <li><button className="starred" onClick={() => props.updateView('starred-notes')}>Starred</button></li>
